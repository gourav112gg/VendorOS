...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ initialTab = 'profile' }) => {
  ...
  const [mfaEnabled, setMfaEnabled] = useState(
    localStorage.getItem("vendoros_security_mfa") === "true",
  );
  const [pinRequired, setPinRequired] = useState(
    localStorage.getItem("vendoros_security_pin_enabled") === "true",
  );
  const [pin, setPin] = useState(
    localStorage.getItem("vendoros_security_pin") || "",
  );
  ...
  const billingPeriodProgress = Math.min(
    100,
    Math.max(5, (daysRemaining / 30) * 100),
  );
    ...
    try {
      if (simulateSuccess) {
        ...
        if (data.webhookProcessed && data.subscription) {
          dbStore.updateCompanySubscription(
            company.id,
            data.subscription,
            user.id,
          );
  ...
  const simulateDirectWebhook = async (
    event:
  ...
  return (
    <div
      ...
      id="settings-pricing-main-viewport"
    >
          ...
          <div className="bg-[#111111] border border-[#222222] p-6 rounded-sm">
            <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-[#222222]">
              ...
              <div>
                ...
                <p className="text-xs text-[#666666] mt-0.5">
                  Control where and how you receive urgent service dispatch
                  alerts.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-[#0A0A0A] border border-[#222222] rounded-sm flex items-start justify-between">
                <div className="space-y-1 mr-3">
                  ...
                  <p className="text-[11px] text-[#666666] leading-relaxed">
                    Alerts for scheduled bookings & status updates.
                  </p>
                </div>
                <button
                  id="notify-email-toggle"
                  onClick={() =>
                    updatePreference("notifyEmail", !preferences.notifyEmail)
                  }
              ...
              <div className="p-4 bg-[#0A0A0A] border border-[#222222] rounded-sm flex items-start justify-between">
                <div className="space-y-1 mr-3">
                  ...
                  <p className="text-[11px] text-[#666666] leading-relaxed">
                    Real-time SMS alerts for field completions.
                  </p>
                </div>
                <button
                  id="notify-sms-toggle"
                  onClick={() =>
                    updatePreference("notifySMS", !preferences.notifySMS)
                  }
                  className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
              ...
              <div className="p-4 bg-[#0A0A0A] border border-[#222222] rounded-sm flex items-start justify-between">
                <div className="space-y-1 mr-3">
                  ...
                  <p className="text-[11px] text-[#666666] leading-relaxed">
                    Direct visual popup-banners inside browser sessions.
                  </p>
                </div>
                <button
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#222222]">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#666666] mt-0.5">
                    Manage session tokens, access PINs, and MFA properties.
                  </p>
                </div>
              </div>
              {securitySuccess && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-5 bg-[#0A0A0A] border border-[#222222] rounded-sm flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[#666666] mt-2.5 leading-relaxed">
                      Require a unique 4-digit PIN to perform final service
                      order dispatches and completions.
                    </p>
                  </div>
                  <div className="mt-4 pt-3 border-t border-[#1A1A1A] flex justify-between items-center text-xs text-[#888888]">
                    <span>Status:</span>
                    <span
                      className={`font-mono font-bold ${pinRequired ? "text-emerald-400" : "text-[#555555]"}`}
                    >
                ...
                <div className="p-5 bg-[#0A0A0A] border border-[#222222] rounded-sm flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[#666666] mt-2.5 leading-relaxed">
                      Simulate a mobile secondary verification prompt on every
                      single portal login session.
                    </p>
                  </div>
                  <div className="mt-4 pt-3 border-t border-[#1A1A1A] flex justify-between items-center text-xs text-[#888888]">
                    <span>Status:</span>
                    <span
                      className={`font-mono font-bold ${mfaEnabled ? "text-emerald-400" : "text-[#555555]"}`}
                    >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                  <div>
                    ...
                    <p className="text-xs text-[#666666] mt-1 leading-relaxed">
                      Log out of all secondary tablets or mobile devices
                      currently hosting this authentication token.
                    </p>
                  </div>
                  <button
                ...
                {[
                  {
                    id: "midnight",
                    name: "Midnight Ocean",
                    colors: ["#0B1120", "#60A5FA"],
                  },
                  {
                    id: "obsidian",
                    name: "Obsidian Ember",
                    colors: ["#0F0F0F", "#D97706"],
                  },
                  {
                    id: "pine",
                    name: "Shadow Pine",
                    colors: ["#0C1A14", "#34D399"],
                  },
                  {
                    id: "graphite",
                    name: "Graphite Periwinkle",
                    colors: ["#1C1C24", "#818CF8"],
                  },
                ].map((preset) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`flex flex-col items-center justify-center p-3.5 rounded-lg border cursor-pointer transition-colors ${
                        isActive
                          ? "bg-white dark:bg-[#1A1A1A] border-stone-400 dark:border-[#444444] text-slate-900 dark:text-white font-semibold shadow-md ring-1 ring-white/10"
                    ...
                    >
                      <div className="flex gap-1.5 mb-2 items-center">
                        <span
                          className="w-3.5 h-3.5 rounded-full border border-stone-300 dark:border-[#333333] shadow-sm"
                      ...
                      <span className="text-[11px] font-mono uppercase tracking-wider text-center">
                        {preset.name}
                      </span>
                      {isActive && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-[#888888] mt-1 leading-relaxed">
                  Select the default currency symbol shown across your service
                  portal.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`p-1.5 rounded-sm ${preferences.currency === "INR" ? "bg-white text-black" : "bg-black"}`}
                    >
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`p-1.5 rounded-sm ${preferences.currency === "USD" ? "bg-white text-black" : "bg-black"}`}
                    >
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-[#888888] mt-1 leading-relaxed">
                  Choose whether the dispatches and schedule list appears on the
                  left or right.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`p-1.5 rounded-sm ${preferences.sidebarPosition === "left" ? "bg-white text-black" : "bg-black"}`}
                    >
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`p-1.5 rounded-sm ${preferences.sidebarPosition === "right" ? "bg-white text-black" : "bg-black"}`}
                    >
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-[#888888] mt-1 leading-relaxed">
                  Shift the sub-navigation tabs to the left or right of the
                  layout.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`p-1.5 rounded-sm ${preferences.navAlignment === "left" ? "bg-white text-black" : "bg-black"}`}
                    >
                      <AlignLeft className="w-3.5 h-3.5" />
                    </div>
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`p-1.5 rounded-sm ${preferences.navAlignment === "right" ? "bg-white text-black" : "bg-black"}`}
                    >
                      <AlignRight className="w-3.5 h-3.5" />
                    </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-[#888888] mt-1 leading-relaxed">
                  Toggle between a horizontal sub-navigation or a sleek vertical
                  side menu.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`p-1.5 rounded-sm ${preferences.navStyle === "horizontal" ? "bg-white text-black" : "bg-black"}`}
                    >
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`p-1.5 rounded-sm ${preferences.navStyle === "sidebar" ? "bg-white text-black" : "bg-black"}`}
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
              ...
              <div className="lg:col-span-5 grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <span
                    className={`inline-flex items-center px-2 py-0.5 rounded-sm text-[9px] font-mono uppercase tracking-widest mt-1 ${getStatusColor(currentSub.status)}`}
                  >
                    <span
                      className={`w-1.5 h-1.5 rounded-full mr-1.5 ${currentSub.status === "active" ? "bg-emerald-500 animate-pulse" : currentSub.status === "past_due" ? "bg-amber-500 animate-pulse" : "bg-red-500"}`}
                    />
                    {currentSub.status}
                  </span>
                </div>
                ...
                <div className="space-y-1 mt-2">
                  ...
                  <span
                    className="text-xs font-mono font-semibold text-[#666666] block truncate max-w-[120px] mt-1 select-all"
                    title={currentSub.razorpaySubscriptionId}
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="w-full bg-[#1A1A1A] h-2 rounded-full overflow-hidden border border-[#222222]">
                    <div
                      ...
                      style={{
                        width: `${usage.limit === Infinity ? 100 : Math.min(100, (usage.used / usage.limit) * 100)}%`,
                      }}
                    />
                  </div>
                </div>
            ...
            {currentSub.status !== "active" && (
              <div className="mt-5 p-4 bg-amber-950/10 border border-amber-900/30 text-amber-500 text-xs flex items-start gap-2.5 rounded-sm">
                ...
                <div className="space-y-1 leading-relaxed">
                  <p className="font-bold uppercase tracking-wider font-mono text-[10px]">
                    Premium Capabilities Soft-Locked
                  </p>
                  <p className="text-[#888888]">
                    Your subscription billing claim is currently flagged as{" "}
                    <strong className="text-amber-500">
                      {currentSub.status.toUpperCase()}
                    </strong>
                    . Advanced systems such as AI Copilot risk scoring, GST
                    invoicing, Trust metrics, and Supplier intelligence are
                    temporarily paused. Complete simulation renewal below to
                    restore instantly.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                ...
                <p className="text-xs text-[#555555] mt-1">
                  Upgrade your company tier to unlock advanced AI modules and
              ...
              <div className="flex items-center space-x-1.5 bg-[#141414] border border-[#222222] p-1 rounded-sm select-none">
                ...
                >
                  <span>Annual</span>
                  <span
                    className={`px-1 py-0.5 text-[7px] rounded-sm font-bold ${billingCycle === "annual" ? "bg-emerald-950 text-emerald-400" : "bg-emerald-500/10 text-emerald-500"}`}
                  >
                    -20%
                  </span>
                </button>
            ...
            {isBillingRestricted && (
              <div className="p-3 bg-[#1A1A1A] border border-[#222222] rounded-sm text-xs text-[#888888] flex items-center gap-2">
                ...
                <span>
                  ...
                  Subscription management and upgrades are read-only and
                  restricted to Company Owners or Managers.
                </span>
              </div>
            )}

            {/* Plans side-by-side cards */}
            <div className="vos-stagger grid grid-cols-1 lg:grid-cols-3 gap-6">
              {(["free", "growth", "scale"] as const).map((tierKey) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-[#111111] border rounded-sm p-6 flex flex-col justify-between relative shadow-md ${
                        ...
                        className={`w-full py-2.5 rounded-sm text-[10px] font-mono font-bold uppercase tracking-widest transition-all cursor-pointer ${
                          isCurrent && currentSub.status === "active"
                            ...
                            : isBillingRestricted
                              ...
                              : isHighlighted
                                ? "bg-white text-black hover:bg-[#F0EAD8]"
          ...
          <div className="bg-[#111111] border border-[#222222] p-6 rounded-sm shadow-md">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
              <div>
                ...
                <p className="text-xs text-[#555555] mt-1">
                  Directly fire simulation webhooks to check app adaptation to
                  payment failures, cancellations, and charged states.
                </p>
              </div>
                ...
                <div className="bg-black border border-[#222222] rounded-sm max-h-40 overflow-y-auto divide-y divide-[#161616] font-mono text-[10px]">
                  {webhookLogs.map((log) => (
                    ...
                    >
                      ...
                      <span
                        className={`px-2 py-0.5 rounded-sm capitalize font-bold text-[9px] ${
                          log.status === "active"
            ...
            <div className="flex items-center space-x-3 pb-3 border-b border-[#222222]">
              ...
              <div>
                <h4 className="text-xs font-mono font-bold text-white uppercase tracking-wider">
                  Set Secure Access PIN
                </h4>
                <p className="text-[10px] text-[#666666]">
                  Enter a 4-digit numeric access key
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSavePIN} className="space-y-4">
              <div className="space-y-2">
                <label
                  ...
                  className="text-[9px] font-mono font-bold text-[#666666] uppercase tracking-widest block"
                >
                ...
                />
                {pinError && (
                  <p className="text-[10px] font-mono text-rose-500 font-bold uppercase tracking-wider">
                    {pinError}
                  </p>
                )}
              </div>
            ...
            >
              ...
              <div className="bg-[#0b0e1a] p-4 flex items-center justify-between border-b border-[#1e2540]">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-[#8c9bb5] block">
                      VendorOS Operations
                    </span>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-[9px] text-[#8c9bb5] uppercase block tracking-widest">
                    Amount
                  </span>
                  <span className="text-sm font-bold text-white">
                    ₹{getTierPrice(checkoutTier)}/
              ...
              <div className="p-5 space-y-4">
                <div className="bg-[#181d33] border border-[#232a4a] p-4 rounded-sm space-y-1.5 text-center">
                  <span className="text-[9px] font-mono text-[#8c9bb5] uppercase tracking-widest">
                    Checkout Simulation
                  </span>
                  <p className="text-xs text-[#ced7e6] leading-relaxed">
                    You are subscribing to the{" "}
                    <strong className="text-white capitalize">
                      {checkoutTier} Edition
                    </strong>{" "}
                    ({billingCycle} cycle).
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <span className="text-[9px] font-mono text-[#8c9bb5] uppercase tracking-widest block">
                  ...
                  <div className="border border-[#232a4a] rounded-sm divide-y divide-[#232a4a] bg-[#181d33]">
                    <div className="p-3 flex items-center justify-between text-xs cursor-pointer hover:bg-[#1f2542]">
                      ...
                      <span className="text-[10px] text-[#8c9bb5] font-mono">
                        Simulated
                      </span>
                    </div>
                    ...
                    <div className="p-3 flex items-center justify-between text-xs cursor-pointer hover:bg-[#1f2542]">
                      <div className="flex items-center space-x-2.5">
                        <span className="text-[#2a75e6] font-bold font-mono text-[10px]">
                          UPI
                        </span>
