...
export const HeroSection: React.FC<HeroSectionProps> = ({ onGetStarted }) => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-28 pb-16 bg-[#09090B] text-white overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 text-center">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-[11px] font-mono text-neutral-400 mb-12"
        >
        ...
        {/* Phone Frame Showcase with Floating Motion */}
        <motion.div
        ...
        >
          {/* Animated Outer Floating Container */}
          <motion.div
            animate={{
              y: [0, -16, 0],
              rotate: [0, 1, 0, -1, 0],
          ...
          >
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute -left-28 top-20 bg-[#121215]/90 backdrop-blur-md border border-[#27272A] rounded-xl px-3.5 py-2 text-[10px] font-mono text-neutral-300 shadow-2xl items-center gap-2 z-20"
            >
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute -right-28 top-20 bg-[#121215]/90 backdrop-blur-md border border-[#27272A] rounded-xl px-3.5 py-2 text-[10px] font-mono text-neutral-300 shadow-2xl flex-col items-start gap-1 z-20"
            >
            ...
            {/* Glowing Ambient Aura Behind Phone */}
            <div className="absolute inset-0 bg-emerald-500/15 blur-3xl rounded-full pointer-events-none scale-110" />
            ...
            <div className="relative mx-auto border-[10px] border-[#1C1C1E] rounded-[42px] overflow-hidden shadow-2xl bg-[#000000] aspect-[9/18] max-w-[280px]">
              ...
              <div className="p-4 pt-8 text-left font-mono space-y-4 text-white">
                ...
                <div className="flex items-center justify-between text-[10px] text-neutral-400 pb-2 border-b border-neutral-800">
                  ...
                  <span className="text-emerald-400 bg-emerald-950/40 px-1.5 py-0.5 rounded text-[8px] animate-pulse">
                    ↑ 12.5%
                  </span>
                </div>
                ...
                {/* Sparkline Visual with Animated Heights */}
                <div className="h-20 bg-[#121215] rounded-xl p-2 border border-neutral-800 flex items-end gap-1 overflow-hidden">
                  {[40, 55, 35, 70, 60, 85, 95, 80, 100].map((h, i) => (
                    <motion.div
                      key={i}
                      initial={{ height: "10%" }}
                      animate={{ height: [`${h}%`, `${Math.max(20, (h + 15) % 100)}%`, `${h}%`] }}
